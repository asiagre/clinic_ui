...
public class AppointmentMapper {
    ...
    public AppointmentDto mapToAppointmentDto(final Appointment appointment) {
        return new AppointmentDto(appointment.getId(), appointment.getDoctor().getId(), appointment.getPatient().getId(), appointment.getSlot());
    }

    public Appointment mapToAppointment(final AppointmentDto appointmentDto, final Doctor doctor, Patient patient) {
        return new Appointment(appointmentDto.getId(), doctor, appointmentDto.getVisitDate(), patient);
    }
